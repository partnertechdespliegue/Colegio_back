...
public class HorarioSalon {
	...
	public Integer getIdHorarioSalon() {
		return idHorarioSalon;
	}

	public void setIdHorarioSalon(Integer idHorarioSalon) {
		this.idHorarioSalon = idHorarioSalon;
	}
